...
published:
created: 2025-12-06
description: Explains the 'Tree of Thoughts (ToT)' framework, where models autonomously generate and evaluate intermediate thoughts and combine search algorithms like BFS/DFS to find optimal solutions for complex problem-solving.
tags:
  - Prompt_Engineering
  - Prompt_Engineering/ToT
  - Reasoning_Technique
  - Search_Algorithm
cover:
---
...
[Prompt Chaining](https://www.promptingguide.ai/techniques/prompt_chaining "Prompt Chaining") [Retrieval Augmented Generation](https://www.promptingguide.ai/techniques/rag "Retrieval Augmented Generation")
