...
source: https://platform.openai.com/docs/guides/structured-outputs?example=chain-of-thought#function-calling-vs-response-format
author:
  - OpenAI
published:
created: 2025-10-29
description: Provides a detailed explanation of the 'Structured Outputs' feature in the OpenAI API, which ensures that model responses strictly adhere to defined JSON schemas. Covers differences from JSON mode, application methods through function calling and response_format, usage examples with libraries like Pydantic and Zod, and real-world use cases such as Chain-of-Thought (CoT), data extraction, and UI generation. Also includes supported schema features, limitations, performance optimization, and error handling strategies.
tags: [OpenAI, Structured_Outputs, JSON_Schema]
cover: https://cdn.openai.com/API/images/platform-opengraph.png
---
...
1.  When using [[Tools for structured data|function calling]]
