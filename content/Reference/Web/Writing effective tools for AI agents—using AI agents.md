...
published:
created: 2025-12-19
description: Introduces principles to consider when designing tools for agents (namespacing, token efficiency, prompt engineering, etc.) and collaborative techniques using Claude Code to automatically evaluate and optimize tool performance.
tags:
  - AI/Agent
  - Tool_Design
  - MCP
...
### [Looking to learn more?](https://anthropic.skilljar.com/)
