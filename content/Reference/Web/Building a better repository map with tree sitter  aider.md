...
created: 2026-03-10
description: "Tree-sitter allows aider to build a repo map that better summarizes large code bases."
tags: [Aider, Tree_Sitter, Repository_Map, Code_Context, AST, AI/Agent, Prompt_Engineering/Context_Engineering]
cover: "https://aider.chat/assets/robot-ast.png"
---
<svg xmlns="http://www.w3.org/2000/svg" class="d-none"><symbol id="svg-link" viewBox="0 0 24 24"><title>Link</title></symbol> <symbol id="svg-arrow-right" viewBox="0 0 24 24"><title>Expand</title></symbol> <symbol id="svg-external-link" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-external-link"><title id="svg-external-link-title">(external link)</title> <path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path><polyline points="15 3 21 3 21 9"></polyline><line x1="10" y1="14" x2="21" y2="3"></line></symbol><symbol id="svg-doc" viewBox="0 0 24 24"><title>Document</title></symbol> <symbol id="svg-copy" viewBox="0 0 16 16"><title>Copy</title></symbol> <symbol id="svg-copied" viewBox="0 0 16 16"><title>Copied</title></symbol></svg>
...
Here’s a sample of the map of the aider repo, just showing the maps of [base\_coder.py](https://github.com/Aider-AI/aider/blob/main/aider/coders/base_coder.py) and [commands.py](https://github.com/Aider-AI/aider/blob/main/aider/commands.py):
