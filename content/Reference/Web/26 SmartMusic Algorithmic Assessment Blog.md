---
title: SmartMusic Algorithmic Assessment Blog
source: https://www.makemusic.com/blog/power-your-teaching-with-smartmusic/
created: 2026-06-14
published:
author:
...
# SmartMusic Algorithmic Assessment Blog

- 원문: [SmartMusic Algorithmic Assessment Blog](https://www.makemusic.com/blog/power-your-teaching-with-smartmusic/)
- 관련 기능: 상용 자동 평가 서비스
- 선별 이유: SmartMusic의 pitch, rhythm, duration 평가와 교육 워크플로우를 설명한 블로그.

## 원문 클리핑

![power your teaching](https://www.makemusic.com/wp-content/uploads/2022/06/SM_PowerYour-campaign_teaching_blog@2x.jpg)
...
Track student progress with the Gradebook where you can access student recordings, assignments, performance scores, practice analytics, and provide students feedback. From the Gradebook, you can evaluate each student’s submitted recording along with SmartMusic’s Assessment feedback given to the student. You can also download recordings, change grades, and reassign. Also, we recently developed a [feature](https://www.makemusic.com/blog/hiding-student-data-in-class-gradebooks-new-tool-for-platform-admins/) for platform administrators that removes students’ identifiable information (names) from class Gradebooks, making the grading and growth tracking process completely blind.
