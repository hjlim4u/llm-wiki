---
title: OMR Datasets
source: https://apacha.github.io/OMR-Datasets/
created: 2026-06-14
published:
author:
type: WebReference
...
- 원문: [OMR Datasets](https://apacha.github.io/OMR-Datasets/)
- 관련 기능: OMR 데이터셋
- 선별 이유: OMR 모델 학습/평가용 공개 데이터셋을 정리한 목록 페이지.
...
If you are interested in Optical Music Recognition research, you can find a curated bibliography at [https://omr-research.github.io/](https://omr-research.github.io/).
...
![Example of HOMUS dataset](https://apacha.github.io/OMR-Datasets/samples/homus.png)
...
![Example of MusicSymbolClassifier dataset](https://apacha.github.io/OMR-Datasets/samples/universal-music-symbol-collection.png)

## CVC-MUSCIMA

**Official website**: [http://www.cvc.uab.es/cvcmuscima/index\_database.html](http://www.cvc.uab.es/cvcmuscima/index_database.html)
...
![Example of CVC MUSCIMA dataset](https://apacha.github.io/OMR-Datasets/samples/cvc-muscima.png)
...
![Example of MUSCIMA++ dataset](https://apacha.github.io/OMR-Datasets/samples/muscima-pp.png)
...
![Example of MUSCIMA++ measure annotations](https://apacha.github.io/OMR-Datasets/samples/muscima-pp-measures.png)
...
The aim of this tool is to provide abundant training data for researchers in the field of handwritten music recognition. It works by taking symbol masks from the MUSCIMA++ dataset and placing them onto a blank staff according to a given annotation. This annotation may be your own, may be generated randomly, or may be taken from the PrIMuS dataset.

**Scientific Publication**: Jiří Mayer and Pavel Pecina. Synthesizing Training Data for Handwritten Music Recognition. 16th International Conference on Document Analysis and Recognition, ICDAR 2021. Lausanne, September 8-10, pp. 626-641, 2021.

**Example**:

![Example of Mashcima](https://apacha.github.io/OMR-Datasets/samples/mashcima.png)
...
**Scientific Publication**: Lukas Tuggener, Isamil Elezi, Jürgen Schmidhuber, Marcello Pelillo, Thilo Stadelmann. [DeepScores - A Dataset for Segmentation, Detection and Classification of Tiny Objects](https://arxiv.org/abs/1804.00525). ICPR 2018.

**Example**:

![Example of deepscores dataset](https://apacha.github.io/OMR-Datasets/samples/DeepScores1.png)
...
![Example of doremi dataset](https://apacha.github.io/OMR-Datasets/samples/doremi-Haydn-Piano-Trio-27-mvt-I-046.png)
...
- Jorge Calvo-Zaragoza and David Rizo. Camera-PrIMuS: Neural end-to-end Optical Music Recognition on realistic monophonic scores. In Proceedings of the 19th International Society for Music Information Retrieval Conference, Paris,
	1. [http://ismir2018.ircam.fr/doc/pdfs/33.pdf](http://ismir2018.ircam.fr/doc/pdfs/33.pdf) (for Camera-PrIMuS)

**Example**:

![Example of primus dataset](https://apacha.github.io/OMR-Datasets/samples/primus.png)
...
![Example of the Baro Single Stave dataset](https://apacha.github.io/OMR-Datasets/samples/baroMuscima.png)
...
![Examples for Bounding Box Annotations of Musical Measures](https://apacha.github.io/OMR-Datasets/samples/bbox-measures.png)
...
![Examples for Bounding Box Annotations of Musical Measures v2](https://apacha.github.io/OMR-Datasets/samples/audio_labs_bbox_annotations.png)
...
**Publication**: Gotham, M. R. H.; and Jonas, P. The OpenScore Lieder Corpus. In Münnich, S.; and Rizo, D., editor(s), Music Encoding Conference Proceedings 2021, pages 131–136, 2022. Humanities Commons. Best Poster Award.
...
**Summary**: Collection of more than 100 string quartets by over 40 composers, encoded by a dedicated team of volunteers in MuseScore with associated data.

**Publication**: Mark Gotham, Maureen Redbond, Bruno Bower, and Peter Jonas. 2023. The “OpenScore String Quartet” Corpus. In Proceedings of the 10th International Conference on Digital Libraries for Musicology (DLfM ‘23). Association for Computing Machinery, New York, NY, USA, 49–57. [https://doi.org/10.1145/3625135.3625155](https://doi.org/10.1145/3625135.3625155)
...
![Example of MuseScore](https://apacha.github.io/OMR-Datasets/samples/musescore.png)
...
![Example of Monophonic MusicXML dataset](https://apacha.github.io/OMR-Datasets/samples/monophonic-musescore.png)
...
![Example of Capitan dataset](https://apacha.github.io/OMR-Datasets/samples/capitan-collection.png)
...
- Emilia Parada-Cabaleiro, Anton Batliner, Alice Baird, Björn W. Schuller. The SEILS dataset: Symbolically Encoded Scores in ModernAncient Notation for Computational Musicology. Proceedings of the 18th International Society of Music Information Retrieval conference, 2017, Suzhou, P.R. China, pp. 575-581. [Download the PDF](https://ismir2017.smcnus.org/wp-content/uploads/2017/10/14_Paper.pdf)
- Emilia Parada-Cabaleiro, Maximilian Schmitt, Anton Batliner, Björn W. Schuller. Musical-Linguistic annotation of Il Lauro Secco. Proceedings of the 19th International Society of Music Information Retrieval conference, 2018, Paris, France, pp. 461-467. [Download the PDF](http://ismir2018.ircam.fr/doc/pdfs/11_Paper.pdf)
- Emilia Parada-Cabaleiro, Anton Batliner, Björn W. Schuller. A diplomatic edition of Il Lauro Secco: Ground truth for OMR of white mensural notation. Proceedings of the 20th International Society of Music Information Retrieval conference, 2019, Delft, The Netherlands, pp. 557-564. [Download the PDF](http://archives.ismir.net/ismir2019/paper/000067.pdf)

**Example**:

![Example of SEILS dataset - original manuscript](https://apacha.github.io/OMR-Datasets/samples/seils1.png) ![Example of SEILS dataset - modern notation](https://apacha.github.io/OMR-Datasets/samples/seils2.png)
...
![Example of Rebelo dataset](https://apacha.github.io/OMR-Datasets/samples/rebelo1.png)
...
![Example of the Fornes Dataset](https://apacha.github.io/OMR-Datasets/samples/choi_accidentals.png)
...
![Example of the Audiveris OMR Dataset](https://apacha.github.io/OMR-Datasets/samples/audiveris-omr.png)
...
![Example of the Printed Music Symbols Dataset](https://apacha.github.io/OMR-Datasets/samples/printed-music-symbols.png)
...
![Example of MusicScoreClassifier dataset](https://apacha.github.io/OMR-Datasets/samples/music-score-classifier.png)
...
![Example of the Printed Music Symbols Dataset](https://apacha.github.io/OMR-Datasets/samples/openomr.png)
...
![Example of the Gamera MusicStaves Dataset](https://apacha.github.io/OMR-Datasets/samples/gamera-music-staves-toolkit.png)
...
![Example of the Pugin dataset](https://apacha.github.io/OMR-Datasets/samples/pugin.png)
...
![The IMSLP music library](https://apacha.github.io/OMR-Datasets/samples/imslp.png)
...
![License](https://img.shields.io/badge/License-Unknown-red.svg) (Authors want to be contacted)
...
![Example of the Byrd Dataset](https://apacha.github.io/OMR-Datasets/samples/byrd.png)
...
![Example of the MScoreLib Dataset](https://apacha.github.io/OMR-Datasets/samples/mscorelib.png)
